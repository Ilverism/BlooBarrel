        ...
        <button class="cursor-pointer relative {buttonClass}" aria-label="Download Release">
            ...
            <div class="px-6 py-8">
                <div class="
                    text-xl!
                    md:text-2xl!
                    platform-asset-name {nameClass} text-shadow-[0_0_8px] text-shadow-blue-400/50 shadow-op px-2
                ">
                    {assetNameFormatted}
                </div>
            </div>
    ...
    >
        ...
        >
            ...
            <div class="p-1 flex shrink-[9999] pr-8">
                <div class="platform-asset-name {nameClass} line-clamp-1!">
                    {assetNameFormatted}
                </div>
            </div>
            ...
            <div class="flex flex-row items-center gap-2 justify-end grow-[9999]">
                ...
                <!-- Download Size -->
                <div class="
                    {assetSizeClass} min-w-fit text-right justify-self-end
                ">
                    {assetSizeFormatted}
                </div>
                ...
                <div class="
                    md:ml-2 md:w-16
                    {downloadCountClass} text-right justify-self-end flex flex-row gap-1 justify-end items-center
                ">
                ...
                <div class="
                    md:ml-2 md:w-8
                    {extensionClass} justify-self-end text-right not-group-hover:truncate group-hover:min-w-fit group-hover:w-fit group-hover:max-w-fit
                ">
                    {asset?.extension}
                </div>
...
<style lang="postcss">
    ...
    .platform-asset-name {
        ...
        @apply md:text-sm;
        @apply break-all text-left align-text-top line-clamp-3;
